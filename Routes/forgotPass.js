...
// console.log(config);
module.exports = function(forgotPass, knex, nodemailer, jwt) {
               ...
               if (!err){
                  ...
                  //  console.log('this is working!', data);
                   ...
                   var transporter = nodemailer.createTransport({
                    ...
                    const mailOptions = {
                     from: `"React Todo" ${config.GMAIL_USER}`, // sender address
                     to: req.body.email, // list of receivers
                     subject: 'Password Reset Request for React Todo', // Subject line
                     html: `<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="padding: 0;">
                        ...
                        <td colspan="2" valign="middle" id="credit" style='border-radius: 6px; border: 0; color: #7d7d7d; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 12px; line-height: 150%; text-align: center; padding: 24px 0;'>
                                                            <p style="margin: 0 0 16px;">Sent by <a href="https://themes.material-ui.com/" style="color: #1976d2; font-weight: normal; text-decoration: underline;">React-Todo</a>.</p>
                                                         </td>
                                                      </tr></table>
                        </td>
                                             </tr></table>
...
// sendMail('satyam18@navgurukul.org','Welcome to Earth',message);